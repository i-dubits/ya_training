...
def inorder_traversal_two_children(root):
    if root.left is not None:
        inorder_traversal_two_children(root.left)

    if root.right is not None and root.left is not None:
        print(root.key)

    if root.right is not None:
        inorder_traversal_two_children(root.right)
...
# display(root)
inorder_traversal_two_children(root)